        ...
        <div class="w-full h-full bg-white border-l border-gray-200 shadow-2xl flex flex-col">
          ...
          <div class="p-6 bg-white border-t border-gray-100 space-y-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
            ...
            <button 
              ...
              class="w-full flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#128C7E] text-white py-4 rounded-lg font-black text-base transition-all mt-4 shadow-sm"
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.898-4.45 9.898-9.898 0-5.449-4.451-9.898-9.898-9.898-5.448 0-9.898 4.45-9.898 9.898 0 2.071.558 3.993 1.572 5.61l-1.161 4.242 4.395-1.546zm10.741-7.531c-.603-.302-3.57-1.765-4.123-1.966-.554-.201-.958-.302-1.36.302-.403.604-1.56 1.966-1.912 2.368-.353.402-.705.453-1.309.151-3.32-1.664-5.26-4.577-5.864-5.584-.302-.503.275-.5.856-1.644.201-.403.101-.755-.05-1.057-.151-.302-1.36-3.284-1.864-4.493-.489-1.166-.983-1.008-1.36-.027l-1.157-.015c-.403 0-1.057.151-1.611.755-1.912 2.164-2.012 4.773-.855 7.491 1.762 4.135 6.262 8.795 10.776 10.373 1.079.378 1.923.604 2.58.774 1.084.28 2.073.24 2.853.146 1.056-.128 3.57-1.46 4.074-2.87.504-1.41.504-2.618.353-2.87-.151-.252-.555-.403-1.159-.705z"/>
              </svg>
              Pesan Sekarang
            </button>
          </div>
